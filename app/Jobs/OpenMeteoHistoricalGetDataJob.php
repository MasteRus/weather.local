...
class OpenMeteoHistoricalGetDataJob implements ShouldQueue
{
    ...
    public function handle(): void {
        Log::info("==========START OpenMeteoGetData Job ================");
        $service = new OpenMeteoSource();
        $service->getData($this->startDate, $this->finishDate, $this->location);
        Log::info("==========Finish OpenMeteoGetData Job ================");
    }
}
